...
public class ZooKeeperApiDemo implements Watcher {
    private final static String CONNECT_STRING = "192.168.25.128:2181";
    ...
    public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
        ...
        ACL acl2 = new ACL(ZooDefs.Perms.CREATE, new Id("ip", "192.168.25.128"));
    ...
    public void process(WatchedEvent watchedEvent) {
        ...
        if (watchedEvent.getState() == Watcher.Event.KeeperState.SyncConnected) {
            if (Watcher.Event.EventType.None == watchedEvent.getType() && null == watchedEvent.getPath()) {
                ...
                System.out.println("Watched Event State: " + watchedEvent.getState());
            ...
            System.out.println("Watched Event Type: " + watchedEvent.getType());
        }
    }
}
