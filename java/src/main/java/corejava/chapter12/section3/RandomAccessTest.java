...
public class RandomAccessTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (DataOutputStream out = new DataOutputStream(new FileOutputStream("E:\\JAVA\\IdeaProjects\\corejava\\src\\corejava.chapter12\\JDBCTest\\employee.dat"))) {
            for (Employee e : staff) {
                writeData(out, e);
            }
        }

        try (RandomAccessFile in = new RandomAccessFile("E:\\JAVA\\IdeaProjects\\corejava\\src\\corejava.chapter12\\JDBCTest\\employee.dat", "r")) {
