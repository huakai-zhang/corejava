...
public class TextFileTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (PrintWriter out = new PrintWriter("E:\\JAVA\\IdeaProjects\\corejava\\src\\chapter12\\section2\\employee.dat", "UTF-8")) {
            writeData(staff, out);
        }

        try (Scanner in = new Scanner(new FileInputStream("E:\\JAVA\\IdeaProjects\\corejava\\src\\chapter12\\section2\\employee.dat"), "UTF-8")) {
