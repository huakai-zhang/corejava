...
public class ObjectStreamTest {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        try (ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("E:\\IDEAFile\\corejava\\src\\chapter12\\section4\\employee.dat"))) {
            out.writeObject(staff);
        }

        try (ObjectInputStream in = new ObjectInputStream(new FileInputStream("E:\\IDEAFile\\corejava\\src\\chapter12\\section4\\employee.dat"))) {
