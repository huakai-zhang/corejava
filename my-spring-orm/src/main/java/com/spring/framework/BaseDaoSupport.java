...
import com.spring.framework.jdbc.BaseDao;
import com.spring.framework.utils.BeanUtils;
import com.spring.framework.utils.DataUtils;
import com.spring.framework.utils.GenericsUtils;
...
//	}
	...
	protected long getCount(QueryRule queryRule) throws Exception {
		com.spring.framework.QueryRuleSqlBuilder bulider = new com.spring.framework.QueryRuleSqlBuilder(queryRule);
