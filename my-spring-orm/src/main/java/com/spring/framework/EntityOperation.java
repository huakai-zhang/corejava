...
public class EntityOperation<T> {
	...
	public EntityOperation(Class<T> clazz,String pk) throws Exception{
		...
		Map<String, Method> getters = com.spring.framework.ClassMappings.findPublicGetters(entityClass);
	    Map<String, Method> setters = com.spring.framework.ClassMappings.findPublicSetters(entityClass);
	    Field[] fields = com.spring.framework.ClassMappings.findFields(entityClass);
...
class PropertyMapping {
    ...
    public PropertyMapping(Method getter, Method setter, Field field) {
        ...
        this.columnName = column == null ? com.spring.framework.ClassMappings.getGetterName(getter) : ("".equals(column.name()) ? com.spring.framework.ClassMappings.getGetterName(getter) : column.name());
